export class Session {
	...
	constructor(id: string, name: string, teachers: string[], startDate: Date, endDate: Date, TP: string, status: SessionStatus) {
		this.id = id;
		this.name = name;
...
export class TeacherSession extends Session {
	...
	constructor(id: string, name: string, teachers: string[], students: string[], startDate: Date, endDate: Date, TP: string, status: SessionStatus) {
