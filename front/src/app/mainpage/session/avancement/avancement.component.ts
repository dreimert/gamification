...
import { avancement, avancements, niveaux } from './avancement';
...
export class AvancementComponent implements OnInit{
  ...
  ngOnInit(): void {
    ...
    const sessionId = decodeURIComponent(segments[segments.length - 2].replace(/%20/g, ' ')) || 'URL does not have enough segments.';
